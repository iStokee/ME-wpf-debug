	...
	public static class ScriptEntry
	{
		...
		private static void InitAndShowWindow()
		{
			...
			void AddDict(string packUri) =>
				app.Resources.MergedDictionaries.Add(new ResourceDictionary { Source = new Uri(packUri, UriKind.RelativeOrAbsolute) });

			// Default to Light theme; ThemeManager will swap if user's setting is dark
